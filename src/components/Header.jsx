...
export default function Header() {
  ...
  return (
    <header className="bg-blue-700 dark:bg-blue-900 text-white sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Escravos de Maria</h1>
              <p className="text-sm text-blue-100">Um Blog feito por Católicos que amam a Igreja</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg bg-blue-600 hover:bg-blue-500 dark:bg-blue-800 dark:hover:bg-blue-700 transition-colors"
